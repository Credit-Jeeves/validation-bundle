...
CREATE TABLE `cj_holding` (
  ...
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `accounting_system` enum('none','yardi voyager','resman','mri','amsi','mri bostonpost','promas','yardi genesis','yardi genesis v2') COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:AccountingSystem)',
  ...
  `use_recurring_charges` tinyint(1) NOT NULL DEFAULT '0',
  `recurring_codes` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `export_tenant_id` tinyint(1) NOT NULL DEFAULT '1',
  `post_app_fee_and_security_deposit` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
INSERT INTO `cj_holding` VALUES (1,'Darryl\'s Holding','2015-09-21 13:17:10','2015-09-21 13:17:10','none',0,0,1,0,NULL,1,0),(2,'Moss Holding','2015-09-21 13:17:10','2015-09-21 13:17:10','none',0,0,1,0,NULL,1,0),(3,'Test Holding','2015-09-21 13:17:10','2015-09-21 13:17:10','none',0,0,1,0,NULL,1,0),(4,'700Credit','2015-07-23 13:17:10','2015-09-13 13:17:10','none',0,0,1,0,NULL,1,0),(5,'Rent Holding','2015-07-23 13:17:10','2015-09-13 13:17:10','yardi voyager',0,0,1,0,NULL,1,0),(6,'Estate Holding','2015-07-23 13:17:10','2015-09-13 13:17:10','none',0,0,1,0,NULL,1,0),(7,'Test RentHolding 2','2015-07-23 13:17:10','2015-09-13 13:17:10','none',0,0,1,0,NULL,1,0),(8,'Test Rent Holding 3','2015-07-23 13:17:10','2015-09-13 13:17:10','none',0,0,1,0,NULL,1,0),(9,'For Group Without Holding','2015-07-23 13:17:10','2015-09-13 13:17:10','none',0,0,1,0,NULL,1,0);
...
CREATE TABLE `cj_order` (
  ...
  `payment_type` enum('bank','card','cash','scanned_check') COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:OrderPaymentType)',
  `sum` decimal(10,2) NOT NULL,
  `fee` decimal(10,2) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `payment_processor` enum('heartland','aci','profit_stars') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'heartland' COMMENT '(DC2Type:PaymentProcessor)',
  ...
  KEY `IDX_DA53B53D4C3A3BB` (`payment_id`),
  CONSTRAINT `FK_DA53B53D1846CDE5` FOREIGN KEY (`cj_applicant_id`) REFERENCES `cj_user` (`id`),
  CONSTRAINT `FK_DA53B53D4C3A3BB` FOREIGN KEY (`payment_id`) REFERENCES `rj_payment` (`id`),
...
INSERT INTO `cj_order` VALUES (1,21,NULL,NULL,'complete','cash',9.00,NULL,'2015-09-21 13:17:14','2015-09-21 13:17:14','heartland',NULL,'submerchant',NULL,NULL),(2,42,9,1,'complete','card',1500.00,NULL,'2015-08-02 13:17:17','2015-08-02 13:17:17','heartland',NULL,'pay_direct',NULL,NULL),(3,42,NULL,1,'complete','card',1800.00,NULL,'2015-08-12 13:17:17','2015-08-12 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(4,42,NULL,1,'complete','card',1500.00,NULL,'2015-08-22 13:17:17','2015-08-22 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(5,42,NULL,1,'error','card',3000.00,NULL,'2015-08-22 13:17:17','2015-08-22 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(6,42,NULL,1,'cancelled','card',1500.00,NULL,'2015-09-21 13:17:17','2015-09-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(7,42,NULL,1,'refunded','card',700.00,NULL,'2015-08-22 13:17:17','2015-08-22 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(8,42,NULL,1,'returned','card',750.00,NULL,'2015-08-22 13:17:17','2015-08-22 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(9,42,NULL,1,'returned','bank',800.00,NULL,'2015-08-22 13:17:17','2015-08-22 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(10,42,NULL,1,'complete','card',1500.00,NULL,'2015-09-01 13:17:17','2015-09-01 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(11,42,NULL,1,'complete','card',1500.00,NULL,'2015-09-11 13:17:17','2015-09-11 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(12,42,NULL,1,'new','card',1500.00,NULL,'2015-09-19 13:17:17','2015-09-19 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(13,47,NULL,1,'new','card',3700.00,NULL,'2015-09-21 13:17:17','2015-09-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(14,42,9,2,'complete','card',1500.00,NULL,'2014-09-16 13:17:17','2014-09-14 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(15,42,NULL,2,'complete','card',1500.00,NULL,'2014-10-16 13:17:17','2014-10-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(16,42,NULL,2,'complete','card',1500.00,NULL,'2014-10-16 13:17:17','2014-10-14 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(17,42,NULL,2,'complete','card',1500.00,NULL,'2014-11-15 13:17:17','2014-11-13 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(18,42,NULL,2,'complete','card',1500.00,NULL,'2014-12-15 13:17:17','2014-12-13 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(19,42,NULL,2,'complete','card',1500.00,NULL,'2015-01-14 13:17:17','2015-01-12 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(20,42,NULL,2,'complete','card',1500.00,NULL,'2015-02-13 13:17:17','2015-02-11 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(21,42,NULL,2,'complete','card',1500.00,NULL,'2015-03-15 13:17:17','2015-03-13 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(22,42,NULL,2,'complete','card',1500.00,NULL,'2015-04-14 13:17:17','2015-04-12 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(23,42,NULL,2,'complete','card',1500.00,NULL,'2015-05-14 13:17:17','2015-05-12 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(24,42,NULL,2,'complete','card',1500.00,NULL,'2015-06-13 13:17:17','2015-06-11 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(25,43,NULL,1,'complete','card',1250.00,NULL,'2015-01-21 13:17:17','2015-01-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(26,43,NULL,1,'complete','card',1250.00,NULL,'2015-02-21 13:17:17','2015-02-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(27,43,NULL,1,'complete','card',1250.00,NULL,'2015-03-21 13:17:17','2015-03-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(28,43,NULL,1,'complete','card',1250.00,NULL,'2015-04-21 13:17:17','2015-04-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(29,43,NULL,1,'complete','card',1250.00,NULL,'2015-05-21 13:17:17','2015-05-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(30,43,NULL,1,'complete','card',1250.00,NULL,'2015-06-21 13:17:17','2015-06-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(31,43,NULL,1,'complete','card',1250.00,NULL,'2015-07-21 13:17:17','2015-07-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(32,42,NULL,1,'complete','card',1250.00,NULL,'2014-10-21 13:17:17','2014-10-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(33,42,NULL,1,'complete','card',1250.00,NULL,'2014-11-21 13:17:17','2014-11-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(34,42,NULL,1,'complete','card',1250.00,NULL,'2014-11-21 13:17:17','2014-11-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(35,42,NULL,1,'complete','card',1250.00,NULL,'2015-01-21 13:17:17','2015-01-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(36,42,NULL,1,'complete','card',1250.00,NULL,'2015-02-21 13:17:17','2015-02-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(37,42,NULL,1,'complete','card',1250.00,NULL,'2015-04-21 13:17:17','2015-04-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(38,42,NULL,1,'complete','card',1250.00,NULL,'2015-04-21 13:17:17','2015-04-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(39,42,NULL,1,'complete','card',1250.00,NULL,'2015-05-21 13:17:17','2015-05-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(40,42,NULL,1,'complete','card',1250.00,NULL,'2015-06-21 13:17:17','2015-06-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(41,42,NULL,1,'complete','card',1250.00,NULL,'2015-07-21 13:17:17','2015-07-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(42,42,NULL,1,'complete','card',1250.00,NULL,'2015-08-21 13:17:17','2015-08-21 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(43,42,NULL,1,'complete','card',1250.00,NULL,'2015-09-20 13:17:17','2015-09-20 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(44,53,NULL,1,'complete','card',1.00,NULL,'2015-09-20 13:17:17','2015-09-20 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(45,53,NULL,1,'complete','card',2.00,NULL,'2015-09-20 13:17:17','2015-09-20 13:17:17','heartland',NULL,'submerchant',NULL,NULL),(46,53,NULL,1,'complete','card',1500.00,NULL,'2015-08-21 13:17:17','2015-08-21 13:17:17','heartland',NULL,'submerchant',3,NULL),(47,42,NULL,1,'complete','card',1000.00,NULL,'2014-01-01 00:00:00','2014-01-01 00:00:00','heartland',NULL,'submerchant',NULL,NULL),(48,42,NULL,1,'complete','card',1000.00,NULL,'2014-02-01 00:00:00','2014-02-01 00:00:00','heartland',NULL,'submerchant',NULL,NULL),(49,42,NULL,1,'complete','card',1000.00,NULL,'2014-03-01 00:00:00','2014-03-01 00:00:00','heartland',NULL,'submerchant',NULL,NULL),(50,42,NULL,1,'complete','card',820.00,NULL,'2014-04-01 00:00:00','2014-04-01 00:00:00','heartland',NULL,'submerchant',NULL,NULL),(51,42,NULL,1,'complete','card',180.00,NULL,'2014-05-05 00:00:00','2014-05-05 00:00:00','heartland',NULL,'submerchant',NULL,NULL),(52,57,NULL,2,'complete','card',1111.00,NULL,'2015-09-20 13:17:17','2015-09-20 13:17:17','heartland',NULL,'submerchant',NULL,NULL);
...
CREATE TABLE `cj_settings` (
  ...
  `updated_at` datetime NOT NULL,
  `login_message` longtext COLLATE utf8_unicode_ci,
  `scoretrack_free_until` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cj_settings` VALUES (1,'CIPy7wPejGPZGMyIZV4ZrB+mlX7/L62i+2mRljqdwjnIYE4pv0k8pPm8fH5BGH4dFMR3UTFgN0QoqdnDe4/cgA==','uvzrzV024jBbGB74YAx3DAXYlB0XyF1wXwgbRlCBtTM=','5DjdCLI+g3OLUBrWFiRNlc6czeVCfBnSS5VD4BhEODc=','uvzrzV024jBbGB74YAx3DAXYlB0XyF1wXwgbRlCBtTM=','Some rules','2015-09-21 13:17:14',NULL,NULL);
...
INSERT INTO `cj_user` VALUES (1,NULL,'admin@creditjeeves.com','admin@creditjeeves.com','admin@creditjeeves.com','admin@creditjeeves.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','5ca33d221fd09f16c1ecba9c1aadc3eb','2015-09-20 13:17:11',0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Administrator',NULL,'Super','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK1M7N',1,1,'en',1,'none',NULL,0,1,'2015-07-23 13:17:11','2015-09-21 13:17:11',NULL,'admin',NULL,0),(2,NULL,'honda-admin','honda-admin','honda-admin','honda-admin',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Bill',NULL,'Gates','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5CKV',1,1,'en',1,'none',NULL,0,1,'2015-09-21 13:17:11','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(3,NULL,'honda@example.com','honda@example.com','honda@example.com','honda@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Honda',NULL,'Dealer','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5D39',1,1,'en',1,'none',NULL,0,0,'2015-09-21 13:17:11','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(4,NULL,'alex.emelyanov.ua@gmail.com','alex.emelyanov.ua@gmail.com','alex.emelyanov.ua@gmail.com','alex.emelyanov.ua@gmail.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Alex',NULL,'Emelyanov','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5DHI',1,1,'en',1,'none',NULL,0,1,'2015-09-21 13:17:11','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(5,1,'darryl@cars.com','darryl@cars.com','darryl@cars.com','darryl@cars.com',1,'dthzxwo5em0w8so4kcogskskko8wsoo','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Darryl',NULL,'Eaton','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5DWN',1,1,'en',1,'none',NULL,1,1,'2015-09-21 13:17:11','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(6,1,'ton@cars.com','ton@cars.com','ton@cars.com','ton@cars.com',1,'jov7szif74ocokso4k8gsc8wcc8osgo','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Ton',NULL,'Sharp','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5EBG',1,1,'en',1,'none',NULL,0,0,'2015-09-21 13:17:11','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(7,1,'alex@cars.com','alex@cars.com','alex@cars.com','alex@cars.com',1,'n1y1foj5rr448gscksg4gog0w84ss4c','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Alex',NULL,'Emelyanov','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5ER4',1,1,'en',1,'none',NULL,0,0,'2015-09-21 13:17:11','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(8,1,'zane@cars.com','zane@cars.com','zane@cars.com','zane@cars.com',1,'djlutrxztncc40okog08gwgcwc40os8','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Zane',NULL,'Stagg','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5F6F',1,1,'en',1,'none',NULL,0,0,'2015-09-21 13:17:11','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(9,1,'darryl@autotrader.com','darryl@autotrader.com','darryl@autotrader.com','darryl@autotrader.com',1,'4axqnxo9e7qc8ccsssk8kko0wgkgcgg','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Darryl',NULL,'Eaton','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5FM6',1,1,'en',1,'none',NULL,1,1,'2015-09-21 13:17:11','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(10,1,'ton@autotrader.com  ','ton@autotrader.com  ','ton@autotrader.com  ','ton@autotrader.com  ',1,'4qcd9ozo45usok84okos4gg484sw0w0','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Ton',NULL,'Sharp','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5G1E',1,1,'en',1,'none',NULL,0,0,'2015-09-21 13:17:11','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(11,1,'zane@autotrader.com','zane@autotrader.com','zane@autotrader.com','zane@autotrader.com',1,'4xkaen6zyb4s084cwogsso80skcwck4','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Zane',NULL,'Stagg','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5GGS',1,1,'en',1,'none',NULL,0,0,'2012-11-29 14:33:35','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(12,NULL,'darryl@autonation.com','darryl@autonation.com','darryl@autonation.com','darryl@autonation.com',1,'te0s83zdoi8cs4ko4ggcwc0sswskkcg','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Darryl',NULL,'Eaton','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5GVR',1,1,'en',1,'none',NULL,0,1,'2012-11-29 14:36:16','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(13,1,'audi@example.com','audi@example.com','audi@example.com','audi@example.com',1,'j5wgeqy8r1ss4sk0wc4o0c08ws8kog8','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'AUDI',NULL,'Dealer','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5HAZ',1,1,'en',1,'none',NULL,0,0,'2012-11-29 14:36:16','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(14,4,'support@700credit.com','support@700credit.com','support@700credit.com','support@700credit.com',1,'jsckt1f1tn4cgwg40kcsksc80wccoso','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'700Credit',NULL,'700Credit','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'1a1dc91c9073',1,1,'en',1,'none',NULL,1,1,'2012-11-29 14:36:16','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(15,4,'support2@700credit.com','support2@700credit.com','support2@700credit.com','support2@700credit.com',1,'qq0701iawys4c00swcgwooks8ss4k44','7b3e63c45d5cb6859f325ab1447321ef',NULL,0,0,NULL,NULL,NULL,'a:1:{i:0;s:10:\"CREDIT_API\";}',0,NULL,'700CreditAPI',NULL,'700CreditAPI','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5I6C',1,1,'en',1,'none',NULL,1,1,'2012-11-29 14:36:16','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(16,NULL,'api@usequity.com','api@usequity.com','api@usequity.com','api@usequity.com',1,'8phum1bknikocckgcoo8co4kg4o04g4','848c4abcaa73a1c14c273cf0d394d4a8',NULL,0,0,NULL,NULL,NULL,'a:1:{i:0;s:13:\"USE_QUITY_API\";}',0,NULL,'USEquityAPI',NULL,'USEquityAPI','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QK5ILW',1,1,'en',1,'none',NULL,1,1,'2012-11-29 14:36:16','2015-09-21 13:17:11',NULL,'dealer',NULL,0),(17,NULL,'alexey.karpik+app1334753295955955@gmail.com','alexey.karpik+app1334753295955955@gmail.com','alexey.karpik+app1334753295955955@gmail.com','alexey.karpik+app1334753295955955@gmail.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Ivan','Petrovich','Gates','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'3751181804','1980-10-22','18LW1dmYAbWnogX0Jj9fJlxbu0FJIWAf2gPvBsF8JL8=',1,'EWA8QK8LV8',1,1,'en',1,'none',1,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(18,NULL,'john@example.com','john@example.com','john@example.com','john@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'John','WAKEFIELD','BREEN','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'9137644215','1957-02-19','WaTk+IDdI29SfMA0Iar98eOUcKJVBRTacimYqTqaflg=',1,'EWA8QK8MHO',1,1,'en',1,'none',1,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(19,NULL,'alex@example.com','alex@example.com','alex@example.com','alex@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'ALEX',NULL,'JORDAN','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'8560370319','1951-01-01','o/XbnU2gkSeBfX3iXG5j6Snq3cGSPl/Akn5yqDFakus=',1,'EWA8QK8MZN',1,1,'en',1,'passed',1,0,0,'2015-09-21 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(20,NULL,'empty@example.com','empty@example.com','empty@example.com','empty@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'OLA','MAE','TAYLOR','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'3097458439','1955-09-14','Hzx9ANUNJMkWJpbUxQwrSi446R4oQLIYFMZsZfbrlUo=',1,'EWA8QK8NHL',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(21,NULL,'emilio@example.com','emilio@example.com','emilio@example.com','emilio@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'BRIAN','P','KURTH','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'7188491319','1957-02-19','67I+L2Pl9SvLEvEhw1Ss16sD19o6mj2HYWeMAKFCVi8=',1,'EWA8QK8NZP',1,1,'en',1,'passed',1,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(22,NULL,'robert@example.com','robert@example.com','robert@example.com','robert@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'ROBERT','SCOTT','BIRMINGHAM','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'7818945369','1957-02-19','hsh/v/SvWEOB7XOEj1Tzuotn0UqChKq41U3n+Ib56Oo=',1,'EWA8QK8OHI',1,1,'en',0,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(23,NULL,'mamazza@example.com','mamazza@example.com','mamazza@example.com','mamazza@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'WILLIAM','N','JOHNSON','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'7818945369','1970-01-01','CjdmjM3h49dVq81ay0Lietv7z7qMTyCY7tnCX4tx48U=',1,'EWA8QK8OZB',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(24,NULL,'marion@example.com','marion@example.com','marion@example.com','marion@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'MARION','R','BRIEN','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'7818945369','1970-01-01','nRDcgyOn6wu2mi+qL4NKLfjSWEQ2dajaAlGtAEON2dc=',1,'EWA8QK8PH0',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(25,NULL,'hugo@example.com','hugo@example.com','hugo@example.com','hugo@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'HUGO','WOSBELLY','RODRIGUEZ','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'7818945369','1970-01-01','EXWuftAv8hCgEE4JMQx7VmW57FzQRs0tu/6mioDHVDs=',1,'EWA8QK8PYS',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(26,NULL,'miguel@example.com','miguel@example.com','miguel@example.com','miguel@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'MIGUEL','M','CENTENO','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'7818945369','1970-01-01','Y7aS5ZM2AaiwP0UJcni+Vg3Hw2uDia0iT1KShhzwHRQ=',1,'EWA8QK8QGI',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(27,NULL,'CONNIE@example.com','connie@example.com','CONNIE@example.com','connie@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'CONNIE','S','WEBSTER','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'','1941-01-01','lQeEBCdr8yXWIHdflkrmC9PNA7TtL+ANyf8wCBNCqoo=',1,'EWA8QK8QY2',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(28,NULL,'lory@example.com','lory@example.com','lory@example.com','lory@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'LORY','M','STEFFANS','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'','1962-09-19','380NKJ9S3Ad4y2DAVJxDDZjKPMd90SHj9TV+ADyjG8c=',1,'EWA8QK8RG0',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(29,NULL,'app3@example.com','app3@example.com','app3@example.com','app3@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'ROBERT','SCOTT','BIRMINGHAM','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'3028320298','1962-06-05','hsh/v/SvWEOB7XOEj1Tzuotn0UqChKq41U3n+Ib56Oo=',1,'EWA8QK8RXN',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(30,NULL,'app4@example.com','app4@example.com','app4@example.com','app4@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'MILDRED',NULL,'RIOS-HERNANDEZ','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'4068921606','2015-09-21','nIDo1db9vq25V2vyEfn6HY2vhKyJS7SdFUrtNjIyE04=',1,'EWA8QK8SF2',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(31,NULL,'app5@example.com','app5@example.com','app5@example.com','app5@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'ANTHONY','D','DELLISANTI','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'4105367237','1956-08-09','Yk1atQG018s86si+DpItfafiuiY+TpGYVavoF6bLkK4=',1,'EWA8QK8SWV',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(32,NULL,'app6@example.com','app6@example.com','app6@example.com','app6@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'LINDA','A','LEMOINE','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'9137644215','2015-09-21','eUt9MpW59ta4Ea9irGF+GpAXklHBBAiGRWKjK/rszl0=',1,'EWA8QK8TEK',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(33,NULL,'app8@example.com','app8@example.com','app8@example.com','app8@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'GARY','A','LINDSAY','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'3048428383','1955-11-30','WaTk+IDdI29SfMA0Iar98eOUcKJVBRTacimYqTqaflg=',1,'EWA8QK8TW4',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(34,NULL,'app9@example.com','app9@example.com','app9@example.com','app9@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'THOMAS','DENNIS','LOPES','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'','2015-09-21','wJVJE2Boh5UkGehexbiRqmMlklpTQgoo2w6o9vyC+Z4=',1,'EWA8QK8UF0',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(35,NULL,'app10@example.com','app10@example.com','app10@example.com','app10@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'ROBYN','L','PIPER','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'7034910325','1968-09-21','hGDZNda+L9PJPWEu2gMRf7hn5Xy1D8VdeP9BpyJ2V7s=',1,'EWA8QK8UYI',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(36,NULL,'app11@example.com','app11@example.com','app11@example.com','app11@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'LAURIEANN','KATHLEEN','RADLEIN','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'','1968-02-14','WO0EKHQP12xEv4rwUOXt0pFf7KXJQ3/awl4T7fjIoLI=',1,'EWA8QK8VGQ',1,1,'en',1,'passed',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(37,NULL,'linda@example.com','linda@example.com','linda@example.com','linda@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,NULL,NULL,NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'','2015-09-21','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'TESTFULL',1,1,'en',1,'none',NULL,0,0,'2015-09-16 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),(38,NULL,'tenant133@example.com','tenant133@example.com','tenant133@example.com','tenant133@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'TIMOTHY','A','APPLEGATE','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'7858655392','1937-11-10','urIQQQ4HYrMIq0SHBrLnGcGvqINAC6IvkGlqFo2cmyc=',1,'EWA8QK8WH6',1,1,'en',1,'passed',NULL,0,0,'2015-08-02 13:17:11','2015-09-21 13:17:11',NULL,'applicant',NULL,0),
l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'7858655392',NULL,'urIQQQ4HYrMIq0SHBrLnGcGvqINAC6IvkGlqFo2cmyc=',1,'EWA8QNB6RW',1,1,'en',1,'passed',NULL,0,1,'2015-08-02 13:17:16','2015-09-21 13:17:16',NULL,'landlord',NULL,0),(66,6,'landlord2@example.com','landlord2@example.com','landlord2@example.com','landlord2@example.com',1,'o96xw0ocxmows8sccc00c0g880c8ok0','1a1dc91c907325c69271ddf0c944bc72','2015-09-20 13:17:16',0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'John','WAKEFIELD','BREEN','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'9137644215','1957-02-19','WaTk+IDdI29SfMA0Iar98eOUcKJVBRTacimYqTqaflg=',0,'EWA8QNB7HE',1,1,'en',1,'none',1,0,1,'2015-08-07 13:17:16','2015-09-21 13:17:16',NULL,'landlord',NULL,0),(67,6,'landlord3@example.com','landlord3@example.com','landlord3@example.com','landlord3@example.com',1,'hzyvknws6k8wggo4s0kcw48k048c40w','1a1dc91c907325c69271ddf0c944bc72','2015-09-20 13:17:16',0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'ALEX',NULL,'JORDAN','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'8603790319','1951-01-01','o/XbnU2gkSeBfX3iXG5j6Snq3cGSPl/Akn5yqDFakus=',1,'EWA8QNB85O',1,1,'en',1,'passed',1,0,0,'2015-08-09 13:17:16','2015-09-21 13:17:16',NULL,'landlord',NULL,0),(68,7,'landlord4@example.com','landlord4@example.com','landlord4@example.com','landlord4@example.com',1,'knlrx4pjhuogskkc4okg048ogswgo8s','1a1dc91c907325c69271ddf0c944bc72','2015-09-16 13:17:16',0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'OLA','MAE','TAYLOR','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'3097458439','1955-09-14','Hzx9ANUNJMkWJpbUxQwrSi446R4oQLIYFMZsZfbrlUo=',1,'EWA8QNB8VM',1,1,'en',0,'passed',NULL,0,1,'2015-08-12 13:17:16','2015-09-21 13:17:16',NULL,'landlord',NULL,0),(69,8,'landlord5@example.com','landlord5@example.com','landlord5@example.com','landlord5@example.com',1,'rmwc4er06f40wogk4skog8k84s8c8k0','1a1dc91c907325c69271ddf0c944bc72','2015-09-20 13:17:16',0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'BRIAN','P','KURTH','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'7188491319','1957-02-19','67I+L2Pl9SvLEvEhw1Ss16sD19o6mj2HYWeMAKFCVi8=',1,'EWA8QNB9ID',1,1,'en',1,'passed',1,0,1,'2015-08-14 13:17:16','2015-09-21 13:17:16',NULL,'landlord',NULL,0),(70,6,'agent1@example.com','agent1@example.com','agent1@example.com','agent1@example.com',1,'ep3ahd5epy0c4cckkw80kc8wcgw4004','1a1dc91c907325c69271ddf0c944bc72','2015-09-20 13:17:16',0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Agent',NULL,'Test','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'','2015-09-21','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',1,'EWA8QNBA4C',0,0,'en',0,'passed',NULL,0,0,'2015-08-02 13:17:16','2015-09-21 13:17:16',NULL,'landlord',NULL,0),(71,6,'landlord6@example.com','landlord6@example.com','landlord6@example.com','landlord6@example.com',1,'fkkdm0o5qagcs480gsc8ssw84w4os88','1a1dc91c907325c69271ddf0c944bc72','2015-09-20 13:17:16',0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'John','WAKEFIELD','BREEN','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,2,'9137644215','1957-02-19','WaTk+IDdI29SfMA0Iar98eOUcKJVBRTacimYqTqaflg=',1,'EWA8QNBAQV',1,1,'en',1,'none',1,0,1,'2015-08-07 13:17:16','2015-09-21 13:17:16',NULL,'landlord',NULL,0),(72,NULL,'anna_lee@example.com','anna_lee@example.com','anna_lee@example.com','anna_lee@example.com',1,'kx6z2ul5ji80ss44w48k0ookcgock8s','1a1dc91c907325c69271ddf0c944bc72',NULL,0,0,NULL,NULL,NULL,'a:0:{}',0,NULL,'Anna',NULL,'Lee','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=','l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',NULL,NULL,NULL,NULL,NULL,'',NULL,'l89cmWbMqHfTbmhNx1N9VzHyqn34xDmSQ+OdbpHzNfc=',0,'EWA8QQ3UZH',1,1,'en',1,'none',NULL,0,0,'2015-09-20 13:17:21','2015-09-21 13:17:21',NULL,'partner',NULL,0);
...
INSERT INTO `migration_versions` VALUES ('20150901130007'),('20150902131237'),('20150902135037'),('20150904141638'),('20150905170648'),('20150911140130'),('20150922134119'),('20150922135019'),('20150922142023'),('20150922142329'),('20150922173155'),('20150923154706'),('20151001111655'),('20151001120032'),('20151001143614'),('20151005114629'),('20151009125950'),('20151009162502'),('20151013183431'),('20151019112557'),('20151019165250'),('20151028171217'),('20151029130701'),('20151030085453'),('20151030122509'),('20151030144017'),('20151030180113'),('20151102103138'),('20151103130125'),('20151103142021'),('20151106115547'),('20151109204121'),('20151117143751'),('20151118191114'),('20151120151902'),('20151201111240'),('20151207113650'),('20151207125109'),('20151209113319'),('20151209113320'),('20151211150514'),('20151211151542'),('20151211164637'),('20151213111329'),('20151213112239'),('20151214195030'),('20151215203313'),('20151218103741'),('20151224115836'),('20151225132941'),('20151230094850'),('20160104120002'),('20160104154643'),('20160119195534'),('20160120121313'),('20160120163630'),('20160121125316'),('20160121175933'),('20160122105249'),('20160125172416'),('20160127135606'),('20160129121357'),('20160129155844'),('20160202172430'),('20160215122444'),('20160215122837'),('20160215130601'),('20160219120911'),('20160226205108'),('20160229093844'),('20160229100412');
...
INSERT INTO `resman_settings` VALUES (1,5,'akEMMXputQ3AkJc4QZmt7/nqM6XgTZcoUHsUWwPrrj0=',0,'https://api.myresman.com/MITS/');
...
CREATE TABLE `rj_aci_collect_pay_group_profile` (
  ...
  `created_at` datetime NOT NULL,
  `billing_account_number` varchar(40) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `rj_aci_collect_pay_profile_billing`
--

DROP TABLE IF EXISTS `rj_aci_collect_pay_profile_billing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_aci_collect_pay_profile_billing` (
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `profile_billing_unique_constraint` (`profile_id`,`division_id`),
  KEY `IDX_A93E11B7CCFA12B8` (`profile_id`),
  CONSTRAINT `FK_A93E11B7CCFA12B8` FOREIGN KEY (`profile_id`) REFERENCES `rj_aci_collect_pay_user_profile` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_aci_collect_pay_profile_billing`
--

LOCK TABLES `rj_aci_collect_pay_profile_billing` WRITE;
/*!40000 ALTER TABLE `rj_aci_collect_pay_profile_billing` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_aci_collect_pay_profile_billing` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `rj_binlist_bank`
--

DROP TABLE IF EXISTS `rj_binlist_bank`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_binlist_bank` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `bank_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `low_debit_fee` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_5260C5F8F4432C88` (`bank_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_binlist_bank`
--

LOCK TABLES `rj_binlist_bank` WRITE;
/*!40000 ALTER TABLE `rj_binlist_bank` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_binlist_bank` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `rj_contract` (
  ...
  `payment_allowed` tinyint(1) NOT NULL DEFAULT '1',
  `report_to_equifax` tinyint(1) DEFAULT '0',
  `equifax_start_at` date DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO
015-08-02 13:17:16','2015-08-02 13:17:16','BLANK',NULL,1,0,NULL),(18,42,5,24,1,3,NULL,'current','0',987.00,NULL,0.00,'2015-08-25',1,1,'2014-01-01','2014-01-01',NULL,'2015-01-01','2018-01-01','2014-01-01 00:00:00','2014-01-01 00:00:00','BLANK',NULL,1,0,NULL),(19,44,5,25,1,2,NULL,'pending','0',66661.00,NULL,0.00,'2015-09-21',0,0,NULL,NULL,NULL,'2015-09-21','2015-12-21','2014-10-21 13:17:16','2015-09-21 13:17:16','BLANK',NULL,1,0,NULL),(20,53,5,24,1,10,NULL,'current','0',850.00,NULL,0.00,'2015-09-22',0,0,NULL,NULL,NULL,'2015-10-21',NULL,'2015-09-01 13:17:16','2015-09-01 13:17:16','BLANK',NULL,1,0,NULL),(21,46,5,25,1,1,NULL,'pending','0',NULL,NULL,0.00,NULL,0,0,NULL,NULL,NULL,NULL,NULL,'2015-08-02 13:17:16','2015-08-02 13:17:16','BLANK',NULL,1,0,NULL),(22,50,5,24,1,11,NULL,'current','0',199.10,NULL,0.00,'2015-09-22',0,0,NULL,NULL,NULL,'2015-06-23','2015-09-11','2015-04-24 13:17:16','2015-04-24 13:17:16','BLANK',NULL,1,0,NULL),(23,57,5,25,1,3,NULL,'current','0',500.00,NULL,0.00,'2015-11-21',0,0,NULL,NULL,NULL,'2015-09-21','2016-09-21','2015-09-20 13:17:16','2015-09-20 13:17:16','BLANK',NULL,1,0,NULL);
...
INSERT INTO `rj_contract_history` VALUES (1,1,NULL,'pending',NULL,NULL,0.00,NULL,0,NULL,NULL,'create','2015-09-21 13:17:17','0',1),(2,2,NULL,'approved',1400.00,NULL,0.00,'2015-09-21',0,'2015-09-21','2015-12-21','create','2015-09-21 13:17:17','0',1),(3,3,NULL,'finished',1500.00,NULL,0.00,'2015-07-23',0,'2014-09-21','2015-07-23','create','2015-09-21 13:17:17','0',1),(4,4,NULL,'finished',1250.00,NULL,0.00,'2015-07-21',0,'2015-01-21','2015-07-21','create','2015-09-21 13:17:17','0',1),(5,5,NULL,'approved',1250.00,NULL,0.00,'2015-09-26',0,'2015-01-26','2015-11-21','create','2015-09-21 13:17:17','0',1),(6,6,NULL,'pending',NULL,NULL,0.00,NULL,0,NULL,'2015-11-20','create','2015-09-21 13:17:17','0',1),(7,7,NULL,'approved',1700.00,NULL,0.00,'2015-09-20',0,'2014-12-16','2015-11-20','create','2015-09-21 13:17:17','0',1),(8,8,NULL,'approved',3700.00,NULL,0.00,'2015-10-11',0,'2015-06-23','2015-09-01','create','2015-09-21 13:17:17','0',1),(9,9,NULL,'current',1750.00,NULL,0.00,'2015-10-11',0,'2014-11-21','2015-11-21','create','2015-09-21 13:17:17','0',1),(10,10,NULL,'current',1750.00,NULL,0.00,'2015-09-24',0,'2015-06-23','2015-11-20','create','2015-09-21 13:17:17','0',1),(11,11,NULL,'current',1750.00,NULL,0.00,'2015-10-06',0,'2015-06-23','2015-11-20','create','2015-09-21 13:17:17','0',1),(12,12,NULL,'current',1750.00,NULL,0.00,'2015-10-06',0,'2015-06-23','2015-11-20','create','2015-09-21 13:17:17','0',1),(13,13,NULL,'current',2100.00,NULL,0.00,'2015-09-20',0,'2015-06-23','2015-11-20','create','2015-09-21 13:17:17','0',1),(14,14,NULL,'approved',2100.00,NULL,0.00,NULL,0,'2015-06-23','2015-11-20','create','2015-09-21 13:17:17','0',1),(15,15,NULL,'finished',2100.00,NULL,0.00,'2015-05-24',0,'2014-09-26','2015-05-24','create','2015-09-21 13:17:17','0',1),(16,16,NULL,'finished',1400.00,NULL,0.00,'2015-05-24',0,'2014-09-26','2015-05-24','create','2015-09-21 13:17:17','0',1),(17,17,NULL,'finished',1400.00,NULL,0.00,'2015-05-24',0,'2014-09-26','2015-05-24','create','2015-09-21 13:17:17','0',1),(18,18,NULL,'current',987.00,NULL,0.00,'2015-08-25',0,'2015-01-01','2018-01-01','create','2015-09-21 13:17:17','0',1),(19,19,NULL,'pending',66661.00,NULL,0.00,'2015-09-21',0,'2015-09-21','2015-12-21','create','2015-09-21 13:17:17','0',1),(20,20,NULL,'current',850.00,NULL,0.00,'2015-09-22',0,'2015-10-21',NULL,'create','2015-09-21 13:17:17','0',1),(21,21,NULL,'pending',NULL,NULL,0.00,NULL,0,NULL,NULL,'create','2015-09-21 13:17:17','0',1),(22,22,NULL,'current',199.10,NULL,0.00,'2015-09-22',0,'2015-06-23','2015-09-11','create','2015-09-21 13:17:17','0',1),(23,23,NULL,'current',500.00,NULL,0.00,'2015-11-21',0,'2015-09-21','2016-09-21','create','2015-09-21 13:17:17','0',1);
...
--
-- Table structure for table `rj_debit_card_binlist`
--

DROP TABLE IF EXISTS `rj_debit_card_binlist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_debit_card_binlist` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `iin` int(11) NOT NULL,
  `card_brand` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `card_sub_brand` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `card_type` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `card_category` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `country_code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bank_id` bigint(20) NOT NULL,
  `bank_url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bank_phone` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bank_city` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_158A514BA672B50C` (`iin`),
  KEY `IDX_158A514B11C8FB41` (`bank_id`),
  CONSTRAINT `FK_158A514B11C8FB41` FOREIGN KEY (`bank_id`) REFERENCES `rj_binlist_bank` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_debit_card_binlist`
--

LOCK TABLES `rj_debit_card_binlist` WRITE;
/*!40000 ALTER TABLE `rj_debit_card_binlist` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_debit_card_binlist` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `rj_deposit_account` (
  ...
  UNIQUE KEY `unique_constraint_account_number` (`type`,`holding_id`,`account_number`,`payment_processor`),
  KEY `IDX_7F2B897FE54D947` (`group_id`),
  KEY `IDX_7F2B8976CD5FBA3` (`holding_id`),
  CONSTRAINT `FK_7F2B8976CD5FBA3` FOREIGN KEY (`holding_id`) REFERENCES `cj_holding` (`id`),
...
INSERT INTO `rj_deposit_account` VALUES (1,24,'Monticeto_Percent','complete',NULL,NULL,'heartland','rent',5,'15235678'),(2,25,'Monticeto_Percent','complete',NULL,NULL,'heartland','rent',5,NULL),(3,26,'WestPac','complete',NULL,NULL,'heartland','rent',5,'12345786'),(4,27,NULL,'init',NULL,NULL,'heartland','rent',5,NULL),(5,32,'RentTrackCorp','complete',NULL,NULL,'heartland','rent',9,NULL);
...
CREATE TABLE `rj_group` (
  ...
  `updated_at` datetime NOT NULL,
  `statement_descriptor` varchar(21) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `rj_group_import_settings`
--

DROP TABLE IF EXISTS `rj_group_import_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_group_import_settings` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `group_id` bigint(20) NOT NULL,
  `source` enum('csv','integrated_api') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'csv' COMMENT '(DC2Type:ImportSource)',
  `import_type` enum('single_property','multi_properties','multi_groups') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'single_property' COMMENT '(DC2Type:ImportType)',
  `csv_field_delimiter` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT ',',
  `csv_text_delimiter` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '"',
  `csv_date_format` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'm/d/Y',
  `api_property_ids` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_FD9643FBFE54D947` (`group_id`),
  CONSTRAINT `FK_FD9643FBFE54D947` FOREIGN KEY (`group_id`) REFERENCES `rj_group` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_group_import_settings`
--

LOCK TABLES `rj_group_import_settings` WRITE;
/*!40000 ALTER TABLE `rj_group_import_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_group_import_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `rj_group_settings` (
  ...
  `allow_pay_anything` tinyint(1) NOT NULL DEFAULT '0',
  `allowed_debit_fee` tinyint(1) NOT NULL DEFAULT '0',
  `type_debit_fee` enum('flat_fee','percentage') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'percentage' COMMENT '(DC2Type:TypeDebitFee)',
  `debit_fee` decimal(10,2) DEFAULT NULL,
  `show_rent_dashboard` tinyint(1) NOT NULL DEFAULT '1',
  `show_rent_wizard` tinyint(1) NOT NULL DEFAULT '1',
  `is_external_resident_follows_unit` tinyint(1) NOT NULL DEFAULT '0',
  `max_limit_per_month` decimal(10,2) NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`),
...
INSERT INTO `rj_group_settings` VALUES (1,24,'heartland',0,1,0,0,1,1,31,NULL,NULL,0,1,'2015-09-21 13:17:15','2015-09-21 13:17:15',0,0,0,'percentage',NULL,1,1,0,0.00),(2,25,'heartland',0,0,0,0,1,1,31,NULL,NULL,0,1,'2015-09-21 13:17:15','2015-09-21 13:17:15',0,0,0,'percentage',NULL,1,1,0,0.00),(3,26,'heartland',0,0,0,0,1,1,31,NULL,NULL,0,1,'2015-09-21 13:17:15','2015-09-21 13:17:15',0,0,0,'percentage',NULL,1,1,0,0.00),(4,27,'heartland',0,0,0,0,1,1,31,NULL,NULL,0,1,'2015-09-21 13:17:15','2015-09-21 13:17:15',0,0,0,'percentage',NULL,1,1,0,0.00),(5,28,'heartland',0,0,0,0,1,1,31,0.00,0.00,1,1,'2015-09-21 13:17:15','2015-09-21 13:17:15',0,0,0,'percentage',NULL,1,1,0,0.00);
/*!40000 ALTER TABLE `rj_group_settings` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rj_hps_payment_account_merchant`
--

DROP TABLE IF EXISTS `rj_hps_payment_account_merchant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_hps_payment_account_merchant` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `payment_account_id` bigint(20) DEFAULT NULL,
  `merchant_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `payment_account_hps_merchant_unique_constraint` (`payment_account_id`,`merchant_name`),
  KEY `IDX_63076281AE9DDE6F` (`payment_account_id`),
  CONSTRAINT `FK_63076281AE9DDE6F` FOREIGN KEY (`payment_account_id`) REFERENCES `rj_payment_account` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_hps_payment_account_merchant`
--

LOCK TABLES `rj_hps_payment_account_merchant` WRITE;
/*!40000 ALTER TABLE `rj_hps_payment_account_merchant` DISABLE KEYS */;
INSERT INTO `rj_hps_payment_account_merchant` VALUES (1,1,'Monticeto_Percent'),(2,2,'Monticeto_Percent'),(3,3,'Monticeto_Percent'),(4,4,'Monticeto_Percent'),(5,5,'Monticeto_Percent'),(6,6,'Monticeto_Percent'),(7,7,'Monticeto_Percent'),(8,8,'WestPac'),(9,9,'RentTrackCorp');
/*!40000 ALTER TABLE `rj_hps_payment_account_merchant` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rj_import`
--

DROP TABLE IF EXISTS `rj_import`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_import` (
  ...
  `group_id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `import_type` enum('property','contract') COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:ImportModelType)',
  `status` enum('running','complete') COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:ImportStatus)',
  `created_at` datetime NOT NULL,
  `finished_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_8066B56EFE54D947` (`group_id`),
  KEY `IDX_8066B56EA76ED395` (`user_id`),
  CONSTRAINT `FK_8066B56EA76ED395` FOREIGN KEY (`user_id`) REFERENCES `cj_user` (`id`),
  CONSTRAINT `FK_8066B56EFE54D947` FOREIGN KEY (`group_id`) REFERENCES `rj_group` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_import`
--

LOCK TABLES `rj_import` WRITE;
/*!40000 ALTER TABLE `rj_import` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_import` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rj_import_api_mapping`
--

DROP TABLE IF EXISTS `rj_import_api_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_import_api_mapping` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `holding_id` bigint(20) DEFAULT NULL,
  ...
  `zip` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_external_property_id` (`holding_id`,`external_property_id`),
  KEY `IDX_AF76F3BC6CD5FBA3` (`holding_id`),
  CONSTRAINT `FK_AF76F3BC6CD5FBA3` FOREIGN KEY (`holding_id`) REFERENCES `cj_holding` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_import_api_mapping`
--

LOCK TABLES `rj_import_api_mapping` WRITE;
/*!40000 ALTER TABLE `rj_import_api_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_import_api_mapping` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `rj_import_property`
--

DROP TABLE IF EXISTS `rj_import_property`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_import_property` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `import_id` bigint(20) NOT NULL,
  `external_property_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `external_building_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_has_units` tinyint(1) NOT NULL DEFAULT '1',
  `property_has_buildings` tinyint(1) NOT NULL DEFAULT '0',
  `unit_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `external_unit_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `city` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `state` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `zip` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` enum('none','error','new_unit','new_property_and_unit','match') COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '(DC2Type:ImportPropertyStatus)',
  `error_messages` longtext COLLATE utf8_unicode_ci COMMENT '(DC2Type:array)',
  `is_processed` tinyint(1) NOT NULL DEFAULT '0',
  `address1` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `allow_multiple_properties` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `IDX_5953B64CB6A263D9` (`import_id`),
  CONSTRAINT `FK_5953B64CB6A263D9` FOREIGN KEY (`import_id`) REFERENCES `rj_import` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_import_property`
--

LOCK TABLES `rj_import_property` WRITE;
/*!40000 ALTER TABLE `rj_import_property` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_import_property` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `rj_import_transformer`
--

DROP TABLE IF EXISTS `rj_import_transformer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_import_transformer` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `holding_id` bigint(20) DEFAULT NULL,
  `group_id` bigint(20) DEFAULT NULL,
  `external_property_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_6DE030FC6CD5FBA3` (`holding_id`),
  KEY `IDX_6DE030FCFE54D947` (`group_id`),
  CONSTRAINT `FK_6DE030FCFE54D947` FOREIGN KEY (`group_id`) REFERENCES `rj_group` (`id`),
  CONSTRAINT `FK_6DE030FC6CD5FBA3` FOREIGN KEY (`holding_id`) REFERENCES `cj_holding` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_import_transformer`
--

LOCK TABLES `rj_import_transformer` WRITE;
/*!40000 ALTER TABLE `rj_import_transformer` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_import_transformer` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `rj_merchant_account_migration`
--

DROP TABLE IF EXISTS `rj_merchant_account_migration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_merchant_account_migration` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `heartland_merchant_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `aci_division_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_31AF9F7FAB0CA086` (`heartland_merchant_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_merchant_account_migration`
--

LOCK TABLES `rj_merchant_account_migration` WRITE;
/*!40000 ALTER TABLE `rj_merchant_account_migration` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_merchant_account_migration` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `rj_mri_settings` (
  ...
  `send_description` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `rj_payment` (
  ...
  `status` enum('active','close','flagged') COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:PaymentStatus)',
...
CREATE TABLE `rj_payment_account` (
  ...
  `payment_processor` enum('heartland','aci','profit_stars') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'heartland' COMMENT '(DC2Type:PaymentProcessor)',
  `type` enum('bank','card','debit_card') COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:PaymentAccountType)',
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `token` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `last_four` varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL,
  `debit_type` enum('debit','signature_non_exempt') COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '(DC2Type:DebitType)',
  PRIMARY KEY (`id`),
...
INSERT INTO `rj_payment_account` VALUES (1,42,25,'heartland','card','Card','2A83E7EB-0558-48EC-A342-A71D0092BD3F','2015-10-31',NULL,'2015-09-16 13:17:17','2015-09-16 13:17:17',NULL,0,NULL,NULL),(2,42,NULL,'heartland','bank','Bank','D98BB91F-952B-452C-A929-9FBEF5E1F0F7',NULL,NULL,'2015-09-16 13:17:17','2015-09-16 13:17:17',NULL,0,NULL,NULL),(3,43,NULL,'heartland','bank','Bank','D98BB91F-952B-452C-A929-9FBEF5E1F0F7',NULL,NULL,'2015-09-16 13:17:17','2015-09-16 13:17:17',NULL,0,NULL,NULL),(4,43,26,'heartland','card','Card','2A83E7EB-0558-48EC-A342-A71D0092BD3F','2016-01-31',NULL,'2015-09-16 13:17:17','2015-09-16 13:17:17',NULL,0,NULL,NULL),(5,45,28,'heartland','card','Card','2A83E7EB-0558-48EC-A342-A71D0092BD3F','2016-02-29',NULL,'2015-09-16 13:17:17','2015-09-16 13:17:17',NULL,0,NULL,NULL),(6,50,NULL,'heartland','bank','Bank account','D98BB91F-952B-452C-A929-9FBEF5E1F0F7',NULL,NULL,'2015-09-16 13:17:17','2015-09-16 13:17:17',NULL,0,NULL,NULL),(7,51,NULL,'heartland','bank','Bank account','D98BB91F-952B-452C-A929-9FBEF5E1F0F7',NULL,NULL,'2014-02-28 00:00:00','2014-02-28 00:00:00',NULL,0,NULL,NULL),(8,50,53,'heartland','card','Card','C09BBB4E-4C08-4295-BF05-EAAF75961D68','2015-10-31',NULL,'2015-09-16 13:17:17','2015-09-16 13:17:17',NULL,0,NULL,NULL),(9,42,25,'heartland','card','RT Card','568C0904-9174-46DE-BEC4-9B76599B28C5','2015-12-31',NULL,'2015-09-16 13:17:17','2015-09-16 13:17:17',NULL,0,NULL,NULL);
...
CREATE TABLE `rj_payment_batch_mapping` (
  ...
  `accounting_package_type` enum('none','yardi voyager','resman','mri','amsi','mri bostonpost','promas','yardi genesis','yardi genesis v2') COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:AccountingSystem)',
  `external_property_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `rj_payment_history`
--

DROP TABLE IF EXISTS `rj_payment_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_payment_history` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `object_id` bigint(20) DEFAULT NULL,
  `contract_id` bigint(20) DEFAULT NULL,
  `payment_account_id` bigint(20) DEFAULT NULL,
  ...
  `logged_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_45FD6AC9232D562B` (`object_id`),
  CONSTRAINT `FK_45FD6AC9232D562B` FOREIGN KEY (`object_id`) REFERENCES `rj_payment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_payment_history`
--

LOCK TABLES `rj_payment_history` WRITE;
/*!40000 ALTER TABLE `rj_payment_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_payment_history` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `rj_profitstars_registered_contracts`
--

DROP TABLE IF EXISTS `rj_profitstars_registered_contracts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_profitstars_registered_contracts` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `contract_id` bigint(20) NOT NULL,
  `location_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_index_constraint` (`contract_id`,`location_id`),
  KEY `IDX_5FE9830D2576E0FD` (`contract_id`),
  CONSTRAINT `FK_5FE9830D2576E0FD` FOREIGN KEY (`contract_id`) REFERENCES `rj_contract` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_profitstars_registered_contracts`
--

LOCK TABLES `rj_profitstars_registered_contracts` WRITE;
/*!40000 ALTER TABLE `rj_profitstars_registered_contracts` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_profitstars_registered_contracts` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rj_profitstars_settings`
--

DROP TABLE IF EXISTS `rj_profitstars_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_profitstars_settings` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `holding_id` bigint(20) NOT NULL,
  `merchant_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_187622E06CD5FBA3` (`holding_id`),
  CONSTRAINT `FK_187622E06CD5FBA3` FOREIGN KEY (`holding_id`) REFERENCES `cj_holding` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_profitstars_settings`
--

LOCK TABLES `rj_profitstars_settings` WRITE;
/*!40000 ALTER TABLE `rj_profitstars_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_profitstars_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `rj_property` (
  ...
  `property_address_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_4837837740168F46` (`property_address_id`),
  CONSTRAINT `FK_4837837740168F46` FOREIGN KEY (`property_address_id`) REFERENCES `rj_property_address` (`id`)
...
INSERT INTO `rj_property` VALUES (1,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,16),(2,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,19),(3,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,15),(4,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,11),(5,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,7),(6,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,2),(7,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,20),(8,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,9),(9,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,6),(10,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,5),(11,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,8),(12,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,10),(13,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,1),(14,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,13),(15,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,12),(16,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,17),(17,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,14),(18,'2015-07-23 13:17:15','2015-09-13 13:17:15',0,18),(19,'2015-09-20 13:17:15','2015-09-20 13:17:15',0,4),(20,'2015-09-21 13:17:15','2015-09-21 13:17:15',0,3);
/*!40000 ALTER TABLE `rj_property` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rj_property_address`
--

DROP TABLE IF EXISTS `rj_property_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_property_address` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `state` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `city` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `ss_lat` double DEFAULT NULL,
  `ss_long` double DEFAULT NULL,
  `ss_index` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_1791C28721F4A992` (`ss_index`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rj_property_address`
--

LOCK TABLES `rj_property_address` WRITE;
/*!40000 ALTER TABLE `rj_property_address` DISABLE KEYS */;
INSERT INTO `rj_property_address` VALUES (1,'Havana','Havana','10 de Octubre','','',NULL,NULL,23.1094238,-82.3658518,'10deOctubreHavanaHavanaInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(2,'MA','Boston','Washington St','10','1114',NULL,NULL,42.2574449,-71.1616868,'10WashingtonStBostonMAInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(3,'CA','Los Angeles','West 36th Place','1156','90007',NULL,NULL,34.021764,-118.293358,'1156West36thPlaceLosAngelesCAInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(4,'NY','New York','Lexington Avenue','116','10016',NULL,1,40.7426129,-73.9828048,'116LexingtonAvenueNewYorkNYInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(5,'TX','Houston','Crosstimbers St','1201','77022',NULL,NULL,29.8287445,-95.3856651,'1201CrosstimbersStHoustonTXInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(6,'MO','Kansas City','W 48th St','121','64112',NULL,NULL,39.038827,-94.588826,'121W48thStKansasCityMOInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(7,'NY','Jamaica','Broadway','1','11414',NULL,NULL,40.6584069,-73.830445,'1BroadwayJamaicaNYInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(8,'Mt','Billings','Overland Ave','2026','59102',NULL,NULL,45.753246,-108.565361,'2026OverlandAveBillingsMtInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(9,'WA','Seattle','18th Ave','50','98122',NULL,NULL,47.6016982,-122.3089461,'5018thAveSeattleWAInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(10,'AZ','Scottsdale','N Palo Cristi Rd','5532','85253',NULL,NULL,33.518351,-112.0041753,'5532NPaloCristiRdScottsdaleAZInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(11,'NY','New York','Broadway','560','10012',NULL,NULL,40.723851,-73.997487,'560BroadwayNewYorkNYInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(12,'AR','Little Rock','S Broadway St','617','72201',NULL,NULL,34.7434652,-92.2759828,'617SBroadwayStLittleRockARInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(13,'IL','Chicago','W Madison St','733','60661',NULL,NULL,41.8810911,-87.6468986,'733WMadisonStChicagoILInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(14,'NY','New York','Broadway','745','10003',NULL,NULL,40.7302448,-73.9927101,'745BroadwayNewYorkNYInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(15,'CA','Mission Canyon','Andante Rd','750','93105',NULL,NULL,34.44987,-119.7096921,'750AndanteRdMissionCanyonCAInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(16,'NY','New York','Broadway','770','10003',NULL,NULL,40.7308364,-73.991567,'770BroadwayNewYorkNYInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(17,'NY','New York','Broadway','776','10003',NULL,NULL,40.7312396,-73.9918488,'776BroadwayNewYorkNYInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(18,'NY','New York','Broadway','785','10003',NULL,NULL,40.7316721,-73.9917422,'785BroadwayNewYorkNYInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(19,'CA','Santa Barbara','Andante Rd','960','93105',NULL,NULL,34.44943,-119.709369,'960AndanteRdSantaBarbaraCAInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01'),(20,'CA','Palos Verdes Estates','Vía Fernandez','','90274',NULL,NULL,33.7880762,-118.3960347,'VíaFernandezPalosVerdesEstatesCAInvalidAddress','2016-04-22 15:21:01','2016-04-22 15:21:01');
/*!40000 ALTER TABLE `rj_property_address` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `rj_smarty_streets_cache`
--

DROP TABLE IF EXISTS `rj_smarty_streets_cache`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rj_smarty_streets_cache` (
...
--
-- Dumping data for table `rj_smarty_streets_cache`
--

LOCK TABLES `rj_smarty_streets_cache` WRITE;
/*!40000 ALTER TABLE `rj_smarty_streets_cache` DISABLE KEYS */;
/*!40000 ALTER TABLE `rj_smarty_streets_cache` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `rj_user_settings` (
  ...
  `scoretrack_free_until` date DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `rj_user_settings` VALUES (1,65,NULL,1,NULL,NULL),(2,42,9,0,'2015-08-21 13:17:19',NULL),(3,51,7,0,'2015-09-21 13:17:19',NULL);
...
CREATE TABLE `yardi_settings` (
  ...
  `post_month_node` enum('none','transaction_date','deposit_date') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'none' COMMENT '(DC2Type:YardiPostMonthOption)',
  `nsf_post_month_node` enum('original_transaction_date','return_transaction_date') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'original_transaction_date' COMMENT '(DC2Type:YardiNsfPostMonthOption)',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2016-04-22 15:35:20
