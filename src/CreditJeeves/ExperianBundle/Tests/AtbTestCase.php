 ...
 */
class AtbTestCase extends BaseTestCase
{
  ...
  /**
   * @test
   * @expectedException AtbException
   * @expectedExceptionMessage Unsupported type '0'
   */
  public function composeBlocksError()
  {
    $atb = $this->getMock('CreditJeeves\ExperianBundle\Atb', array('getTradeLines', 'getDirectCheck'), array(), '', false);
    $atb->composeBlocks(array('sim_type' => 0, 'blocks' => array(array('tr_acctnum' => '123'))));
  ...
  protected function getMockAtb($tradeLines = array())
  {
    ...
    $atb = $this->getMock('Atb', array('getTradeLines', 'getDirectCheck'), array(), '', false);
  ...
  public function parseATBResponse()
  {
    ...
    $obj = new stdClass();
    $obj->code = 0;
    $obj->result = file_get_contents(sfConfig::get('sf_data_dir') . '/experian/atb/Response.xml');
  ...
  public function parseATBResponse2()
  {
    ...
    $obj = new stdClass();
    $obj->code = 0;
    $obj->result = file_get_contents(sfConfig::get('sf_data_dir') . '/experian/atb/Response2.xml');
  ...
  public function parseATBResponseError()
  {
    ...
    $obj = new stdClass();
    $obj->code = 0;
    $obj->result = file_get_contents(sfConfig::get('sf_data_dir') . '/experian/atb/Error.xml');
  ...
  public function parseATBResponseEmpty()
  {
    ...
    $obj = new stdClass();
    $obj->code = 0;
    $obj->result = file_get_contents(sfConfig::get('sf_data_dir') . '/experian/atb/Empty.xml');
    $result = $atb->parseATBResponse($obj);
