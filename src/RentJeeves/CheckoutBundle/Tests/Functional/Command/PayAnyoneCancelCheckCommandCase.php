...
namespace RentJeeves\CheckoutBundle\Tests\Functional\Functional\Command;
...
class PayAnyoneCancelCheckCommandCase extends BaseTestCase
{
    /**
     * @var CommandTester
     */
    ...
    protected function getCommand()
    {
        if (is_null($this->command)) {
            ...
            $application->add(new PayAnyoneCancelCheckCommand());

            $this->command = $application->find('payment:pay-anyone:cancel-check');
        }
