...
class SmartyStreetsCacheServiceCase extends BaseTestCase
{
    ...
    public function shouldAddRowToDbWhenCallSaveForNewCacheId()
    {
        ...
        $this->assertCount(5, $allCache, 'Check fixtures: fixtures should contain data for SmartyStreetsCache');
        ...
        $allCache = $this->getEntityManager()->getRepository('RjDataBundle:SmartyStreetsCache')->findAll();
        $this->assertCount(6, $allCache, 'SS cache should be added for empty data');
    }
    ...
    public function shouldNotAddRowToDbWhenCallSaveForNewEmptyCacheId()
    {
        ...
        $allCache = $this->getEntityManager()->getRepository('RjDataBundle:SmartyStreetsCache')->findAll();
        $this->assertCount(5, $allCache, 'SS cache should not be added for empty data');
    }
    ...
    public function shouldRemoveExistRowForDelete()
    {
        ...
        $allCache = $this->getEntityManager()->getRepository('RjDataBundle:SmartyStreetsCache')->findAll();
        $this->assertCount(6, $allCache, 'Check creating new object SmartyStreetsCache');
        ...
        $allCache = $this->getEntityManager()->getRepository('RjDataBundle:SmartyStreetsCache')->findAll();
        $this->assertCount(5, $allCache, 'Data not removed');
    }
