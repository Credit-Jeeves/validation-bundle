...
use RentJeeves\ExternalApiBundle\Command\YardiSyncBalanceCommand;
...
class YardiSyncBalanceCommandCase extends BaseTestCase
{
    ...
    public function shouldCreateJobForSyncBalance()
    {
        ...
        $holding->getYardiSettings()->setSyncBalance(true);
        ...
        $application->add(new YardiSyncBalanceCommand());

        $command = $application->find('api:yardi:sync-balance');
