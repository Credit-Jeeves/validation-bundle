...
namespace RentJeeves\ImportBundle\Tests\Unit\LeaseImport\Transformer;
...
use RentJeeves\ImportBundle\LeaseImport\Transformer\MRITransformer;
use RentJeeves\ImportBundle\LeaseImport\Transformer\TransformerFactory;
use RentJeeves\ImportBundle\LeaseImport\Transformer\TransformerInterface;
...
class TransformerFactoryCase extends UnitTestBase
{
    ...
    {
        $customFileDist = __DIR__ . '/../../../../LeaseImport/Transformer/Custom/ExampleCustomTransformer.php.dist';
        $this->tmpFiles[] = __DIR__ . '/../../../../LeaseImport/Transformer/Custom/ExampleCustomTransformer.php';
    ...
    protected function createCustomAndParentTransformersFile()
    {
        ...
        $this->tmpFiles[] = __DIR__ . '/../../../../LeaseImport/Transformer/Custom/ExampleCustomTransformer.php';
        copy($customFileDist, $this->tmpFiles[0]);
        $customFileDist = __DIR__ . '/../../../Fixtures/CustomLeaseTransformers/ChildExampleCustomTransformer.php.dist';
        $this->tmpFiles[] = __DIR__ . '/../../../Fixtures/CustomLeaseTransformers/ChildExampleCustomTransformer.php';
        copy($customFileDist, $this->tmpFiles[1]);
    }

    protected function createInvalidCustomTransformerFile()
    {
        $customFileDist = __DIR__ . '/../../../Fixtures/CustomLeaseTransformers/InvalidCustomTransformer.php.dist';
        $this->tmpFiles[] = __DIR__ . '/../../../Fixtures/CustomLeaseTransformers/InvalidCustomTransformer.php';
        copy($customFileDist, $this->tmpFiles[0]);
    }

    protected function createCustomTransformerWithInvalidNamespace()
    {
        $customFileDist = __DIR__ .
            '/../../../Fixtures/CustomLeaseTransformers/CustomTransformerWithInvalidNamespace.php.dist';
        $this->tmpFiles[] = __DIR__ .
            '/../../../Fixtures/CustomLeaseTransformers/CustomTransformerWithInvalidNamespace.php';
        copy($customFileDist, $this->tmpFiles[0]);
    }
    ...
    public function shouldThrowExceptionIfDbHasRecordForInputDataButFileWithReturnedNameNotFound()
    {
        ...
        $repoMock->expects($this->once())
            ...
            ->with(
                $this->equalTo($group),
                $this->equalTo('test'),
                $this->equalTo(ImportModelType::LEASE)
            )
        ...
        $factory = new TransformerFactory(
            $em,
            $this->getLoggerMock(),
            [__DIR__ . '/../../../../LeaseImport/Transformer/Custom']
        );
        $factory->addApiTransformer(AccountingSystem::MRI, $this->getMriTransformerMock());
    ...
    public function shouldThrowExceptionIfDbHasRecordForInputDataButClassNotOverrideBaseTransformer()
    {
        ...
        $factory = new TransformerFactory(
            $em,
            $this->getLoggerMock(),
            [__DIR__ . '/../../../Fixtures/CustomLeaseTransformers']
        );
        $factory->addApiTransformer(AccountingSystem::MRI, $this->getMriTransformerMock());
        $factory->getTransformer($group, 'test');
    }
    ...
    public function shouldCreateCustomTransformerIfDbHasRecordForInputData()
    {
        ...
        $factory->addApiTransformer(AccountingSystem::MRI, $mriTransformer);
    ...
    public function shouldReturnCsvTransformerIfGroupSettingsHaveCsvSource()
    {
        ...
        $factory->setCsvTransformer($this->getBaseMock(CsvTransformer::class));
    ...
    {
        return $this->getBaseMock(MRITransformer::class);
    }
