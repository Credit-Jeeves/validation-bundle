...
class ImportCase extends BaseTestCase
{
    ...
    public function withoutPayment()
    {
        ...
        $this->assertEquals('11/07/2013', $contract->getStartAt()->format('m/d/Y'));
        $this->assertEquals('11/06/2014', $contract->getFinishAt()->format('m/d/Y'));
    ...
    public function checkFormatDate()
    {
        ...
        $this->assertEquals('12/29/2012<br>12/27/2013', $td[7]->getHtml(), $td[7]->getHtml());
        $datepicker = $result[1]->findAll('css', '.datepicker');
        $this->assertEquals(2, count($datepicker));
        $this->assertEquals('11/08/2013', $datepicker[0]->getValue(), $datepicker[0]->getValue());
        $this->assertEquals('11/07/2014', $datepicker[1]->getValue(), $datepicker[1]->getValue());
        $this->logout();
    }
}
