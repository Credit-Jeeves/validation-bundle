...
class SAMLEnvelopeCase extends BaseTestCase
{
    ...
    public function shouldUseBase64ToEncodePortalApplication()
    {
        ...
        $this->assertEquals('', $saml->encodePortalApplication());
    }
    ...
    public function shouldUseBase64ToEncodeAssertionResponse()
    {
        ...
        $this->assertEquals('PFRlc3RFbGVtZW50PlNvbWUgdGVzdCBkYXRhIGluc2lkZTwvVGVzdEVsZW1lbnQ+', $saml->encodeAssertionResponse($dom));
    }
    ...
    public function shouldCreateValidPortalApplicationData()
    {
        ...
        $this->assertTrue($portalApplication->schemaValidate(__DIR__.'/../Fixtures/InboundApplicationConfiguration.xsd'));
    }
